            ...
            return (
              ...
              <div class="card mb-3 cardSize" key={i} >
                ...
                <div class="bg-dark card-img-overlay text-white d-flex flex-column justify-content-center storeOpacity">
                  ...
                  <p class="card-text"><strong>위치</strong> : {foodCago.곱창[i].위치}</p>
                  <p class="card-text"><strong>특징</strong> : {foodCago.곱창[i].특징}</p>
                  <p class="card-text"><strong>평균가격</strong> : {foodCago.곱창[i].가격}</p>
                </div>
              </div>
              </div>
            );
