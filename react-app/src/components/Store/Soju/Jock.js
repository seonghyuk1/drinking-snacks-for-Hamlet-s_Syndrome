                ...
                <div class="card-body">
                  <div>
                    ...
                    <img
                      ...
                      onClick={() => {
                        // like[i] ? alert(foodCago.족발[i].식당 + "뺌") : alert(foodCago.족발[i].식당 + "족발목록에 담김");
                        ...
                        내가찜한거.find((e) => e.식당 === foodCago.족발[i].식당) ? alert("이미 있음") : (alert("해당 상품 추가 완료"), axios.post("/selection", body));
                  ...
                  <p class="card-text">위치 : {foodCago.족발[i].위치}</p>
                  <p class="card-text">특징 : {foodCago.족발[i].특징}</p>
                  <p class="card-text">평균가격 : {foodCago.족발[i].가격}</p>
                </div>
              </div>
            );
          })}
