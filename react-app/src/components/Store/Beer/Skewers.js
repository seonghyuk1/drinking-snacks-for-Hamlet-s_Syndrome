              ...
              return (
                <div class="col-6 col-xl-3 mx-auto">
                  <div class="card mb-3 cardSize" key={i}>
                    <img class="card-img" src={`/assets/snacks/3/Skewers/${i}.jpg`} alt="..." height="600px" />
                    <div class="bg-dark card-img-overlay text-white d-flex flex-column justify-content-center storeOpacity">
                      ...
                      <p class="card-text">
                        <strong>위치</strong> : {foodCago.닭꼬치[i].위치}
                      </p>
                      <p class="card-text">
                        <strong>특징</strong> : {foodCago.닭꼬치[i].특징}
                      </p>
                      <p class="card-text">
                        <strong>평균가격</strong> : {foodCago.닭꼬치[i].가격}
                      </p>
                    </div>
                  </div>
                </div>
